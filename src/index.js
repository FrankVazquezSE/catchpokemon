...
function App() {
  ...
  useEffect(() => {
    encounterWildPokemon()//This line has an issue "React Hook useEffect has  amissing dependency: 'encounterWildPokemon'. Either include it or remove the dependency array."
  }, [])
//leaving this empty will run every time any state is entered]
